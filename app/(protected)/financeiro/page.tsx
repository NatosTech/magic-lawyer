      ...
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-8 py-12">
        <header className="space-y-4">
          ...
          <p className={subtitle({ fullWidth: true })}>
            Estamos construindo integrações com gateways de pagamento e centros
            de custo para que cada escritório acompanhe faturamento,
            inadimplência e fluxo de caixa em tempo real.
          </p>
        </header>
