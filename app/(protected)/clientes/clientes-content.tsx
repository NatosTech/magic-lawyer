      ...
      >
        <div>
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
            Gerencie sua carteira de clientes e acompanhe seus processos
          </p>
        </div>
              ...
              <CardBody className="p-6">
                ...
                <div className="mt-4">
                  <Progress
                    ...
                    value={
                      metrics.total > 0
                        ? (metrics.comAcesso / metrics.total) * 100
                        : 0
                    }
                  />
                </div>
              ...
              <CardBody className="p-6">
                ...
                <div className="mt-4">
                  <Progress
                    ...
                    value={
                      metrics.total > 0
                        ? (metrics.fisica / metrics.total) * 100
                        : 0
                    }
                  />
                </div>
              ...
              <CardBody className="p-6">
                ...
                <div className="mt-4">
                  <Progress
                    ...
                    value={
                      metrics.total > 0
                        ? (metrics.juridica / metrics.total) * 100
                        : 0
                    }
                  />
                </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Input
              description={
                criarUsuario ? "Obrigatório para criar usuário" : undefined
              }
          ...
          {formState.tipoPessoa === TipoPessoa.JURIDICA && (
            <>
              ...
              <Input
                ...
                onValueChange={(value) =>
                  setFormState({ ...formState, responsavelNome: value })
                }
              />
              <div className="grid grid-cols-2 gap-4">
                <Input
                  ...
                  onValueChange={(value) =>
                    setFormState({ ...formState, responsavelEmail: value })
                  }
                />
                <Input
                  ...
                  onValueChange={(value) =>
                    setFormState({ ...formState, responsavelTelefone: value })
                  }
                />
              </div>
            </>
