    ...
    <section className="mx-auto flex w-full max-w-5xl flex-col gap-8 py-12">
      <header className="space-y-4">
        ...
        <h1 className={title({ size: "lg", color: "blue" })}>
          Painel inteligente do escritório
        </h1>
        <p className={subtitle({ fullWidth: true })}>
          Esta área exibirá métricas resumidas sobre prazos, satisfação dos
          clientes e produtividade da equipe. Estamos estruturando integrações
          com os módulos de processos, documentos e financeiro para consolidar
          tudo aqui.
        </p>
      </header>
