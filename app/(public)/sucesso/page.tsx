        ...
        <Card className="border border-white/10 bg-background/70 backdrop-blur-xl">
          <CardBody className="text-center p-8">
            <div className="mb-6">
              ...
              <h1 className="text-2xl font-bold text-white mb-2 animate-slide-up">Conta criada com sucesso! 🎉</h1>
              <p className="text-default-400 animate-slide-up-delay">Sua conta Magic Lawyer foi criada e está pronta para uso.</p>
            </div>
            ...
            <div className="space-y-3">
              <Button as={Link} href="/login" color="primary" size="lg" className="w-full hover:scale-105 transition-transform">
                🔗 Fazer Login Agora
              </Button>

              <Button as={Link} href="/precos" variant="light" size="lg" className="w-full hover:scale-105 transition-transform">
                ← Voltar aos Planos
              </Button>
            </div>
