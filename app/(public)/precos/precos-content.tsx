      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 py-12">
        ...
        >
          ...
          <p className={subtitle({ fullWidth: true })}>
            ...
            escritório. Todos os planos incluem suporte especializado e
        ...
        <motion.div
          animate={{ opacity: 1, y: 0 }}
          className="grid gap-6 lg:grid-cols-3 pt-8"
            ...
            >
              ...
              >
                <CardHeader className="flex flex-col gap-3 pb-4 text-center">
                  <div
                    className={`text-4xl mb-2 ${isPopular(index) ? "mt-4" : ""}`}
                  >
                  ...
                  <div className="flex items-baseline justify-center gap-1">
                    <span className="text-3xl font-bold text-white">
                      R${" "}
                      {plano.valorMensal
                        ? Number(plano.valorMensal).toLocaleString("pt-BR", {
                  ...
                  {plano.valorAnual && (
                    <p className="text-xs text-default-500">
                      💰 R${" "}
                      {Number(plano.valorAnual).toLocaleString("pt-BR", {
                        minimumFractionDigits: 2,
                      })}
                      /ano (2 meses grátis)
                    </p>
            ...
            <CardBody className="pt-4">
              <div className="grid gap-6 md:grid-cols-2">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-2xl group-hover:bg-primary/20 transition-colors duration-300">
                      {feature.icon}
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-default-400 group-hover:text-default-300 transition-colors duration-300">
                        {feature.description}
                      </p>
                    </div>
                  </motion.div>
