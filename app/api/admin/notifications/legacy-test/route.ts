...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    switch (action) {
      case "create_legacy":
        const notificationId = await NotificationMigrationService.createLegacyNotification({
      ...
      case "test_mapping":
        ...
        const result = await NotificationMigrationService.createLegacyNotification(testData);
