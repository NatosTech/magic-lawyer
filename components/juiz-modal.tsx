...
export default function JuizModal({ juizId, isOpen, onClose }: JuizModalProps) {
  ...
  console.log("JuizModal - Estado:", { juiz: !!juiz, isLoading, isError, isFavorito });
      ...
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            <Avatar src={juiz.foto || undefined} name={juiz.nome} size="lg" className="flex-shrink-0" />
                      ...
                      {juiz.email && (
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <a href={`mailto:${juiz.email}`} className="mt-1 text-sm text-primary hover:underline">
                              {juiz.email}
                            </a>
                          </div>
                        </div>
                      ...
                      {juiz.telefone && (
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <a href={`tel:${juiz.telefone}`} className="mt-1 text-sm text-primary hover:underline">
                              {juiz.telefone}
                            </a>
                          </div>
                        </div>
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          ...
                          {juiz.tribunal.siteUrl && (
                            <div className="md:col-span-2">
                              ...
                              <a href={juiz.tribunal.siteUrl} target="_blank" rel="noopener noreferrer" className="mt-1 text-sm text-primary hover:underline flex items-center gap-1">
                                {juiz.tribunal.siteUrl}
                  ...
                  <Card className="border border-default-200">
                    ...
                    <CardBody>
                      <div className="flex flex-wrap gap-3">
                        {juiz.website && (
                          <a href={juiz.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary hover:underline">
                        ...
                        {juiz.linkedin && (
                          <a href={juiz.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary hover:underline">
                        ...
                        {juiz.twitter && (
                          <a href={juiz.twitter} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary hover:underline">
                        ...
                        {juiz.instagram && (
                          <a href={juiz.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary hover:underline">
