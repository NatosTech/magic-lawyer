...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input, Select, SelectItem, Card, CardBody, Divider, Chip, Spinner, Tabs, Tab } from "@heroui/react";
                    ...
                    <div className="space-y-4">
                      ...
                      <Select
                        ...
                        onSelectionChange={(keys) => {
                          ...
                          setFormaPagamento(selected as "PIX" | "BOLETO" | "CARTAO");
                        }}
                      >
                        <SelectItem key="PIX" value="PIX">
                          PIX (Recomendado)
                        </SelectItem>
                        <SelectItem key="BOLETO" value="BOLETO">
                          Boleto Bancário
                        </SelectItem>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <Input
                            ...
                            isRequired
                          />
                          <Input label="CVV" placeholder="000" value={dadosCartao.cvv} onChange={(e) => setDadosCartao({ ...dadosCartao, cvv: e.target.value })} isRequired />
                          <Input label="Mês" placeholder="MM" value={dadosCartao.mes} onChange={(e) => setDadosCartao({ ...dadosCartao, mes: e.target.value })} isRequired />
                          <Input label="Ano" placeholder="AAAA" value={dadosCartao.ano} onChange={(e) => setDadosCartao({ ...dadosCartao, ano: e.target.value })} isRequired />
                        </div>
                      </div>
                    )}
                  </>
                              ...
                              <CardBody className="p-4 text-center">
                                ...
                                {dadosPagamento.qrCodeImage && (
                                  <div className="flex justify-center mb-4">
                                    <img src={dadosPagamento.qrCodeImage} alt="QR Code PIX" className="w-48 h-48 border border-success/20 rounded-lg" />
                                  </div>
                                )}
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex gap-2">
                                    <Input value={dadosPagamento.chavePix} readOnly className="flex-1" />
                        ...
                        <Tab key="boleto" title="Boleto">
                          <div className="space-y-4">
                            <Card className="bg-warning/5 border border-warning/20">
                              <CardBody className="p-4 text-center">
                                <h3 className="font-semibold text-warning mb-2">Boleto Gerado com Sucesso!</h3>
                                <p className="text-sm text-default-600 mb-4">Baixe o boleto ou copie o código de barras</p>

                                <div className="space-y-4">
                                  <Button color="warning" variant="solid" size="lg" className="w-full" onPress={() => window.open(dadosPagamento.codigoBarras, "_blank")}>
                                    Baixar Boleto
                                  </Button>
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                      <Input value={dadosPagamento.linhaDigitavel} readOnly className="flex-1" />
                                      <Button color="warning" variant="flat" onPress={() => copyToClipboard(dadosPagamento.linhaDigitavel)}>
                                        Copiar
                                      </Button>
                                    </div>
                                  </div>
                          ...
                          <div className="space-y-4">
                            <Card className="bg-primary/5 border border-primary/20">
                              <CardBody className="p-4 text-center">
                                ...
                                <div className="space-y-4">
                                  <Chip color={dadosPagamento.status === "CONFIRMED" ? "success" : "warning"} variant="flat" size="lg">
            ...
            <ModalFooter>
              {!dadosPagamento ? (
                <>
                  ...
                  <Button color="primary" onPress={handleGerarCobranca} disabled={isLoading} startContent={isLoading ? <Spinner size="sm" /> : null}>
