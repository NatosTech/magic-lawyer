...
class NotificationPolicy {
     ...
     */
    static getDefaultUrgency(eventType) {
     ...
     */
    static getDefaultChannels(eventType, urgency) {
     ...
     */
    static getRequiredFieldsMapping() {
        return {
            // PROCESSOS
            "processo.created": ["processoId", "numero", "clienteNome"],
            "processo.updated": ["processoId", "numero"],
     ...
     */
    static canDisableEvent(eventType) {
     ...
     */
    static getQueuePriority(urgency) {
        const priorityMap = {
            CRITICAL: 1,
            HIGH: 2,
            MEDIUM: 3,
