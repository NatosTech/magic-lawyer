...
exports.convertDecimalFields = convertDecimalFields;
exports.convertAllDecimalFields = convertAllDecimalFields;
const prisma_1 = require("../generated/prisma");
const { Decimal } = prisma_1.Prisma;
 ...
 */
function convertDecimalFields(obj, fields) {
 ...
 */
function convertAllDecimalFields(obj) {
    if (!obj || typeof obj !== "object")
        return obj;
    const result = { ...obj };
    for (const key in result) {
