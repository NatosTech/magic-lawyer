-- CreateSchema
CREATE SCHEMA IF NOT EXISTS "magiclawyer";
...
-- CreateEnum
CREATE TYPE "magiclawyer"."TipoEndereco" AS ENUM ('MATRIZ', 'FILIAL', 'ESCRITORIO');
...
-- CreateTable
CREATE TABLE "magiclawyer"."AuditLog" (
    "id" TEXT NOT NULL,
    "tenantId" TEXT NOT NULL,
    "usuarioId" TEXT,
    "acao" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "AuditLog_tenantId_entidade_idx" ON "magiclawyer"."AuditLog"("tenantId", "entidade");

-- CreateIndex
CREATE INDEX "AuditLog_tenantId_createdAt_idx" ON "magiclawyer"."AuditLog"("tenantId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "magiclawyer"."AuditLog" ADD CONSTRAINT "AuditLog_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "magiclawyer"."Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "magiclawyer"."AuditLog" ADD CONSTRAINT "AuditLog_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "magiclawyer"."Usuario"("id") ON DELETE SET NULL ON UPDATE CASCADE;
